...
<div class = "col-md-6">
<br><br>Some history, maybe. Since XXXX year, GGE students, administrators and faculty have come together to organize an annual trip around California. Some more history that emphasizes the legacy.
</div>
</div>
...
```{r, echo = F, results = "asis", fig.width= 10, fig.height=3}
